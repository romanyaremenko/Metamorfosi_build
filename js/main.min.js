...
if (partnersBlock) {
  ...
  e.forEach(function (c, r) {
    c.addEventListener("click", function () {
      e.forEach(function (e) {
        e.classList.remove("active");
      }), t.forEach(function (e, t) {
        r === t ? (e.classList.add("active"), c.classList.add("active")) : e.classList.remove("active");
      });
    });
  });
}
...
customSelect && document.querySelectorAll(".select").forEach(function (e) {
  ...
  if (t) {
    var c = e.querySelector(".select__list"),
        r = e.querySelector(".select__input"),
        o = e.querySelectorAll(".select__item");
    t.addEventListener("click", function () {
  ...
  for (var _e2 = 0; _e2 < c.length; _e2++) {
    c[_e2].addEventListener("mouseenter", r), c[_e2].addEventListener("mouseleave", o);
  }
...
try {
  var _loop = function _loop() {
    ...
    e.addEventListener("click", function (t) {
      t.preventDefault(), hamburegOpen.classList.add("active"), hamburegMenu.classList.remove("active"), hamburegClose.classList.remove("active"), document.querySelector("body").classList.toggle("hidden");
